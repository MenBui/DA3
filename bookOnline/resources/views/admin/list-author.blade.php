					...
					<tbody>
						...
						<tr>
							...
							<td class="jsgrid-cell jsgrid-control-field jsgrid-align-center " style="width: 50px;">
								<a href="{{URL::route('deleteAuthor',[$au->id])}}" onclick="return confirmDelete('Bạn có chắc chắn muốn xóa tác giả này không?')"><button class="jsgrid-button jsgrid-edit-button ti-trash" type="button" title="Delete" ></button></a>
								<a href="{{URL::route('editAuthor',[$au->id])}}"><button class="jsgrid-button jsgrid-delete-button ti-pencil-alt" type="button" title="Edit"></button></a>
							</td>
						</tr>
