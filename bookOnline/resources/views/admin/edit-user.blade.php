		...
		<div class="box box-block bg-white">
			...
			<form action="{{URL::route('postEditUser',[$us->id])}}" method="POST" > 
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="address" placeholder="Địa chỉ" value="{{$us->address}}">
				</div>
				...
				<div class="form-group">
					...
					<input type="password" class="form-control" name="confirm_password" placeholder="Password" value="{{$us->password}}">
				</div> -->
				<div class="form-group">
					<label for="exampleInputEmail1">Số điện thoại</label>
					<input type="text" class="form-control" name="phone" placeholder="Số điện thoại" value="{{$us->phone}}">
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">CMND</label>
					<input type="text" class="form-control" name="cmnd" placeholder="CMND" value="{{$us->cmnd}}">
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Ngày sinh</label>
					<input type="date" class="form-control-file" name="date" placeholder="Ngày sinh" value="{{$us->date}}">
