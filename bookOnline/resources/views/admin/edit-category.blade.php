...
<div class="content-area py-1">
	<div class="container-fluid">
		...
		<ol class="breadcrumb no-bg mb-1">
			...
			<li class="breadcrumb-item active">Sửa danh mục sách</li>
		</ol>
		<div class="box box-block bg-white">
			...
			<form action="{{URL::route('postEditCategory',[$category->id])}}" method="POST">
				<input type="hidden" name="_token" value="{{csrf_token()}}">
				<div class="form-group">
					<label for="exampleInputEmail1">Danh mục sách</label>
					<input type="text" class="form-control" name="name" placeholder="Danh mục sách" value="{{$category->name}}">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="title" placeholder="url_id" value="{{$url_category->title}}">
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Seo Keyword</label>
					<input type="text" class="form-control" name="keyword_seo" placeholder="Seo Keyword" value="{{$url_category->keyword_seo}}">
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Seo Description</label>
					<input type="text" class="form-control" name="description_seo" placeholder="Seo Keyword" value="{{$url_category->description_seo}}">
				</div>
				<div class="form-group">
					<label for="exampleInputFile">Ảnh đại diện</label>
					<input type="file" class="form-control-file" name="image_seo" value="{{$url_category->image_seo}}">
				</div>
